...
import 'package:ssms_revamp/reusable_widgets/reusable_widget.dart';
import 'package:hive_flutter/hive_flutter.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class SignUpCustPage extends StatelessWidget {
                  ...
                  child: Column(children: [
                    ...
                    firebaseUIButton(context, "Sign Up", () {
                      FirebaseAuth.instance
                        ...
                        final String name = _emailTextController.text;

                        if (name!=null) {
                        await _roles
                              .add({"email": name, "role": "customer",});};
