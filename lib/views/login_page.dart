            ...
            child: Center(
                ...
                child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          GoRouter.of(context).push(APP_PAGE.signincust.toPath);
                        },
                        child: Container(
                          padding: const EdgeInsets.all(25),
                          margin: const EdgeInsets.symmetric(horizontal: 25),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              GoRouter.of(context).push(APP_PAGE.customer.toPath);
                            },
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              GoRouter.of(context).push(APP_PAGE.signupcust.toPath);
                            },
